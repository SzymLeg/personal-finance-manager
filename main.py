...
st.set_page_config(page_title="Financial App", layout="wide", page_icon="💰")
...
def main():
    st.title("Financial App Dashboard")
    ...
    if uploaded_file is not None:
        ...
        if df is not None:
            ...
            with tab1:
                ...
                edited_df = st.data_editor(
                    ...
                    column_config={
                        ...
                        "Amount": st.column_config.NumberColumn("Amount", format="%.2f PLN"),
            ...
            with tab2:
                ...
                st.metric("Total Payments", f"{total_payments:,.2f} PLN")
                st.write(credit_df)
